...
-- TMCFrame (main)
local TMCFrame = CreateFrame("Frame", "TMCFrame", UIParent) --name the frame "TMCFrame" for the table.insert
TMCFrame:Hide()
...
table.insert(UISpecialFrames, "TMCFrame") --this code add the "close with escape" feature
-- end TMCFrame
